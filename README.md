...
pip install git+ssh://git@github.com/simplechecks/simplechecks-sdk-python.git
```
...
```sh
# install from the production repo
pip install 'simplechecks[aiohttp] @ git+ssh://git@github.com/simplechecks/simplechecks-sdk-python.git'
```
...
The async client returns an [`AsyncAPIResponse`](https://github.com/simplechecks/simplechecks-sdk-python/tree/main/src/simplechecks/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/simplechecks/simplechecks-sdk-python/issues) with questions, bugs, or suggestions.
